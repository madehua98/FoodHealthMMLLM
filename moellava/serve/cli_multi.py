...
from moellava.serve.utils import load_image, image_ext, video_ext
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="D:/1.5/Video-LLaVA/checkpoints/llava-v1.5-7b-IM-pool_mlp2x_gelu-VID-pool_mlp2x_gelu")
