...
default_cfgs = {
    'faster_vit_0_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_0_224_1k.pth.tar',
        crop_pct=0.875,
        input_size=(3, 224, 224),
        crop_mode='center'),
    'faster_vit_1_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_1_224_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center'),
    'faster_vit_2_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_2_224_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center'),
    'faster_vit_3_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_3_224_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center'),
    'faster_vit_4_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_4_224_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center'),
    'faster_vit_5_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_5_224_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center'),
    'faster_vit_6_any_res': _cfg(
        url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_6_224_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center'),
}
...
class FasterViTLayer(nn.Module):
    ...
    def __init__(self,
        ...
        if conv:
            ...
            sr_ratio = [input_resolution[0] // window_size if not only_local else 1,
...
class FasterViT(nn.Module):
    ...
    def __init__(self,
                 ...
                 do_propagation=False, extract_feat=False,
                 **kwargs):
        """
        Args:
            dim: feature size dimension.
...
if __name__ == "__main__":
    ...
    image_size = [384, 640]
    img = torch.ones([2, 3, image_size[0], image_size[1]]).to(device)
    model = faster_vit_0_any_res(pretrained=True, model_path="/home/xuzhenbo/Downloads/fastervit_0_224_1k.pth.tar",
                                 resolution=image_size, window_size=[7, 7, 12, 6], extract_feat=True).to(device)
    out = model(img) # [1/8, 1/16, 1/32]
