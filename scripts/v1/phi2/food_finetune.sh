...
# --data_path ${json_folder}/101_train_prompt10.json \
#             ${json_folder}/train_ingredient_QA.json ${json_folder}/train_recipe_QA.json ${json_folder}/train_title_QA.json \
#             ${json_folder}/2k_train_prompt10.json \
#             ${json_folder}/172_train_prompt10.json ${json_folder}/172_ingredient_train_prompt10.json \
...
gpus="0,1,2,3,4,8,9"
deepspeed --include localhost:$gpus --master_port=2224 /home/data_llm/FoodHealthMMLLM/moellava/train/train_xformers.py \
    --deepspeed ../../zero2.json \
    --model_name_or_path microsoft/phi-2 \
    --version phi \
    --data_path ${json_folder}/weight_dataset_train2.json ${json_folder}/train_nutrition_QA.json ${json_folder}/nutrition5k_train.json ${json_folder}/mix_food.json \
