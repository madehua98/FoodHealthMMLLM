...
HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed moellava/train/train_mem.py \
    ...
    --train_modules up_proj down_proj gate_proj wg \
    --deepspeed ./scripts/zero2.json \
    --model_name_or_path ./checkpoints/llavaopenchat-7b-finetune \
    --version openchat \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llavaopenchat-7b-finetune-moe \
    --num_train_epochs 1 \
